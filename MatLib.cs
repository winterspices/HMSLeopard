...
namespace Leopard
{
    public class MatLib
    {
        ...
        {
            convexHull = GameObject.Find("BOAT medi medium (50)/medi medium new/structure_container/mask").GetComponent<MeshRenderer>().material;
            foam = GameObject.Find("BOAT medi medium (50)/WaterFoam (1)").GetComponent<MeshRenderer>().material;
            objectInteraction = GameObject.Find("BOAT medi medium (50)/WaterObjectInteractionSphereBack").GetComponent<MeshRenderer>().material;
            water4 = GameObject.Find("BOAT medi medium (50)/medi medium new/damage_water").GetComponent<MeshRenderer>().material;
